 ...
 * This class is to create a regular album 
 * */
using System;
...
namespace KpopAlbumDatabase
{
    class Regular: Album
    {
        public Regular(string title, string artist, int year, string category, string description, Image albumImage, string albumType)
        {
            // create a single
            this.title = title;
            this.artist = artist;
